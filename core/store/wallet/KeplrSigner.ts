...
export class KeplrSigner extends Signer {
  ...
  async signDirect (
    ...
    return await this.client.signDirect(this.chainInfo.chainId, signerAddress, signDoc);
  }
  ...
  async signAmino (
    ...
    this.assertConnected();
    assert(this.accountData);
    return await this.client.signAmino(this.chainInfo.chainId, signerAddress, signDoc);
  }
